...
{
    public class PastaBible : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Projectiles.MagicBibleBallProj>(); // The projectile that weapons fire when using this item as ammunition.
